...
$res= mysqli_query($link, "SELECT COUNT(*) as cnt FROM lot");
...
if ($result = mysqli_query($link, $sql)) {
    $openBets = mysqli_fetch_all($result, MYSQLI_ASSOC);
    $page__content = renderTemplate('templates/main.php', ['cur_page' => $cur_page, 'pages' => $pages, 'pages_count' => $pages_count, 'openBets' => $openBets, 'category' => $category]);
} else {
